...
```{r}
<<<<<<< HEAD
require(individual_merge)
 big_merge <- country_merge_exp %>% right_join(individual_merge,                                           by=(c("Country of Exploitation.y"="Country of Exploitation",
=======
...
>>>>>>> 9773ed3195b820d8b6c13ddc936b6881f94cad21
...
population_full_gathered$Year <- gsub('[a-z]+', '', pop_vec)
...
colnames(population_full_gathered_filterCitizCandYear)[2] <- "Year of Registration"
...
colnames(population_full_gathered_filterTraffCandYear)[2] <- "Year of Registration"
