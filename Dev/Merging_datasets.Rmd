...
migrationFromCountryToWorldBools <- migration$`Major area, region, country or area of destination` == "WORLD"
migrationFromCountryToWorld <- migration[migrationFromCountryToWorldBools, ]
migrationFromCountryToWorld <- na.omit(migrationFromCountryToWorld)
View(migrationFromCountryToWorld)
...
##STILL WORKING ON THIS
migCountryOfCitizenshipToWorld <- 
