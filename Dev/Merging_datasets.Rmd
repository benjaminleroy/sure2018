...
population_full <- linearly_interpolate(populationOrdered, list(2:70))
...
for(i in 0:13) {
  1950 + (5 * i)
  population$pop1950 %>% pull() %>% as.vector()
  
}



population2 <- population %>% mutate(p)

population_LI <- linearly_interpolate(population2, list(3:16))
View(population_LI)
