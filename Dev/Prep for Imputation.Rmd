...
#For reasons below, we have removed "isSexAndLabour" column from the dataset
#furthermore the variable isSexAndLabour has a 1 in 23 instances and in each of them
#both isForcedLabour and isSexualExploit have a 1 as well
pred_matrix[,"isSexAndLabour"] <- NULL
```
...
test_run <- mice_new(big_merge_datasets_factor, 
                     data_corrected = correct_data(big_merge_datasets_factor, option = "empirical"),
                     blocks = block_list, 
                     predictorMatrix = pred_matrix, seed = 1729,
                     m = 5, maxit = 10)
