...
#
for(i in list(30:46, 49:52, 53:61, 68:71)){
...
imp_dataset_names<-colnames(big_merge_dataset)
...
```{r}
pred_matrix <- mice::make.predictorMatrix(big_merge_datasets, block_list)
#View(pred_matrix)
row.names(pred_matrix)<- paste("B", 1:nrow(pred_matrix), sep = "")
