...
#sapply(merged_as_ints, unique)
#Columns with NA and one other value: 0 or 1
...
#RE DO THE NAS AND MEANS OF CONTROL AFTER DOING THE FILL NAS .....

# MAYBE WE KNOW WHAT THE VALUE ACTUALLY IS 
...
merged_as_ints <- sapply(merged_as_ints, as.factor)
...
imp2 <- mice(data = merged_dataset, maxit = 0, method = "logreg",
              blocks = list(colnames(merged_as_ints)[30:47], 
                            colnames(merged_as_ints)[48:66], 
                            colnames(merged_as_ints)[67:72]))
